...
class Progression(models.Model):
    ...
    lastmodifyby = models.ForeignKey(
        User, related_name='%(class)s_modifier', null=True, on_delete=models.DO_NOTHING)
...
class Challenge (models.Model):
    shortname = models.CharField(max_length=60)
    longname = models.CharField(max_length=255)
    challengetypeid = models.ForeignKey(
        ChallengeType, on_delete=models.CASCADE)
    displayorder = models.IntegerField(blank=True, null=True)
...
class ChallengeCurriculum (models.Model):
    challengeid = models.ForeignKey(
        Challenge, related_name='challengecurriculums', on_delete=models.CASCADE)
...
class StudentChallengeEvent (models.Model):
    ...
    instructorid = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name="instructor_user")
